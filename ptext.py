...
DEFAULT_FONT_NAME = "Resources/Vera.ttf"
BACKUP_FONT_NAME = "Resources/Vera.ttf"
...
class _Span:
    ...
    def __init__(self, text, tagspec, x, font,bgfont=None):
    ...
    def getwidth(self, text):
        try:
            ...
            return self.backupfont.size(text)[0]
    ...
    def render(self):
        if self.gcolor is None:
            ...
            try:
                ...
                self.surf = self.backupfont.render(*args).convert_alpha()
        else:
