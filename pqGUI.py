...
class App:
    ...
    def __init__(self, size=(320, 320), shortcuts={}):
        """Initialize pygame and the application."""
        pygame.init()
        #pygame.key.set_repeat(*App.key_repeat)
        self.flags = NOFRAME  # RESIZABLE, FULLSCREEN, NOFRAME
...
# 
#     cities = ['Amsterdam', 'Berlin', 'Cardiff', 'Dublin', 'Edinbourgh', 'Fargo', 'Greenwich', 'Harrington', 'Melbourne','filler1','filler2','filler3','filler4']
